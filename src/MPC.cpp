...
// size_t is an integer type, so these operations are being used to 
// establish the start indices of each state and actuator (8 total).
size_t x_start = 0;
 ...
 public:
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
    ...
    for (int t = 1; t < N; t++) {
      ...
      // note that most of this code is essentially the same as the 
      // implementation in the mind the line quiz, the lines below
      // are different because we are modeling a 3rd order polynomial
...
vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs) {
  bool ok = true;
  //size_t i; commented out because part of scaffold code but not used
